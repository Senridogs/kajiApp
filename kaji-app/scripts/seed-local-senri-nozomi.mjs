...
const CHORE_TEMPLATES = [
  { title: "食器洗い", legacyTitleEn: "Dish Washing", intervalDays: 1, icon: "sparkles", iconColor: "#FFFFFF", bgColor: "#FBBC05" },
  { title: "トイレ掃除", legacyTitleEn: "Toilet Cleaning", intervalDays: 4, icon: "flame", iconColor: "#FFFFFF", bgColor: "#EA4335" },
  { title: "シンク掃除", legacyTitleEn: "Sink Cleaning", intervalDays: 3, icon: "droplets", iconColor: "#FFFFFF", bgColor: "#4285F4" },
  { title: "お風呂掃除", legacyTitleEn: "Bath Scrub", intervalDays: 7, icon: "droplets", iconColor: "#FFFFFF", bgColor: "#34A853" },
  { title: "洗濯", legacyTitleEn: "Laundry", intervalDays: 2, icon: "shirt", iconColor: "#FFFFFF", bgColor: "#4285F4" },
  { title: "洗濯物を干す", legacyTitleEn: "Dry Laundry", intervalDays: 2, icon: "wind", iconColor: "#FFFFFF", bgColor: "#34A853" },
  { title: "洗濯物をたたむ", legacyTitleEn: "Fold Laundry", intervalDays: 2, icon: "shirt", iconColor: "#FFFFFF", bgColor: "#FBBC05" },
  { title: "ゴミ出し", legacyTitleEn: "Take Out Trash", intervalDays: 1, icon: "trash", iconColor: "#FFFFFF", bgColor: "#EA4335" },
  { title: "床に掃除機をかける", legacyTitleEn: "Vacuum Floors", intervalDays: 3, icon: "sparkles", iconColor: "#FFFFFF", bgColor: "#34A853" },
  { title: "床拭き", legacyTitleEn: "Mop Floors", intervalDays: 7, icon: "droplets", iconColor: "#FFFFFF", bgColor: "#4285F4" },
  { title: "棚のほこり取り", legacyTitleEn: "Dust Shelves", intervalDays: 5, icon: "sparkles", iconColor: "#FFFFFF", bgColor: "#FBBC05" },
  { title: "鏡を磨く", legacyTitleEn: "Clean Mirrors", intervalDays: 6, icon: "sparkles", iconColor: "#FFFFFF", bgColor: "#4285F4" },
  { title: "窓拭き", legacyTitleEn: "Window Wipe", intervalDays: 14, icon: "sun", iconColor: "#FFFFFF", bgColor: "#34A853" },
  { title: "シーツ交換", legacyTitleEn: "Change Bed Sheets", intervalDays: 10, icon: "moon", iconColor: "#FFFFFF", bgColor: "#EA4335" },
  { title: "植物に水やり", legacyTitleEn: "Water Plants", intervalDays: 3, icon: "leaf", iconColor: "#FFFFFF", bgColor: "#34A853" },
  { title: "冷蔵庫チェック", legacyTitleEn: "Fridge Check", intervalDays: 7, icon: "sparkles", iconColor: "#FFFFFF", bgColor: "#FBBC05" },
  { title: "パントリー整理", legacyTitleEn: "Pantry Organize", intervalDays: 21, icon: "sparkles", iconColor: "#FFFFFF", bgColor: "#4285F4" },
  { title: "排水口掃除", legacyTitleEn: "Bathroom Drain", intervalDays: 14, icon: "droplets", iconColor: "#FFFFFF", bgColor: "#EA4335" },
  { title: "エアコンフィルター掃除", legacyTitleEn: "AC Filter", intervalDays: 30, icon: "wind", iconColor: "#FFFFFF", bgColor: "#34A853" },
  { title: "換気扇掃除", legacyTitleEn: "Range Hood", intervalDays: 30, icon: "flame", iconColor: "#FFFFFF", bgColor: "#EA4335" },
  { title: "電子レンジ掃除", legacyTitleEn: "Microwave Clean", intervalDays: 10, icon: "sparkles", iconColor: "#FFFFFF", bgColor: "#FBBC05" },
  { title: "コンロ掃除", legacyTitleEn: "Stove Top", intervalDays: 3, icon: "flame", iconColor: "#FFFFFF", bgColor: "#EA4335" },
  { title: "玄関を掃く", legacyTitleEn: "Entryway Sweep", intervalDays: 4, icon: "wind", iconColor: "#FFFFFF", bgColor: "#4285F4" },
  { title: "靴箱整理", legacyTitleEn: "Shoe Rack Organize", intervalDays: 14, icon: "sparkles", iconColor: "#FFFFFF", bgColor: "#34A853" },
  { title: "タオル交換", legacyTitleEn: "Towel Replace", intervalDays: 3, icon: "shirt", iconColor: "#FFFFFF", bgColor: "#FBBC05" },
  { title: "机拭き", legacyTitleEn: "Desk Wipe", intervalDays: 3, icon: "sparkles", iconColor: "#FFFFFF", bgColor: "#4285F4" },
  { title: "ペットスペース掃除", legacyTitleEn: "Pet Area Clean", intervalDays: 2, icon: "heart", iconColor: "#FFFFFF", bgColor: "#EA4335" },
  { title: "資源ごみの分別", legacyTitleEn: "Recycle Sort", intervalDays: 2, icon: "leaf", iconColor: "#FFFFFF", bgColor: "#34A853" },
  { title: "クローゼット整理", legacyTitleEn: "Closet Organize", intervalDays: 30, icon: "shirt", iconColor: "#FFFFFF", bgColor: "#FBBC05" },
  { title: "季節の大掃除", legacyTitleEn: "Seasonal Deep Clean", intervalDays: 45, icon: "sun", iconColor: "#FFFFFF", bgColor: "#4285F4" },
];
